...
function AddRunnerModal({
  ...
  const command = `npx github:che-codes-01/cua#packages/runner --service-url ${process.env.NEXT_PUBLIC_SERVICE_URL || "wss://cua-service.vercel.app"} --api-key ${maskedApiKey}`;
